...
/**
 * @desc Selects randomly from a weighted list of choices
 * @param {Array} choices a list of choices to roll over
 * @param {Array} weights corresponding weights for each choice
 * @returns a randomly selected weighted choice from the list
 * @example const choice = rollWeighted(["apples", "bananas", "grapes"], [2, 4, 3]);
 */
 ...
 * @returns a color from `colorDict`
 * @see {@link formatRoll}
 */
// TODO add @see for colorDict
